...
public class Deck_32 implements GameObject
{
    ...
    public Card getRandomCard(String instrument)
    {
        ...
        while(instrument.equals("piano") && (r < 0 || r > 7))
        {
            r = rand.nextInt(32);
        }
        while(instrument.equals("drum") && (r < 8 || r > 15))
        {
            r = rand.nextInt(32);
        }
        while(instrument.equals("harp") && (r < 16 || r > 23))
        {
            r = rand.nextInt(32);
        }
        while(instrument.equals("saxophone") && (r < 24 || r > 31))
        {
            r = rand.nextInt(32);
        }
    ...
    public void makeCardBlueprints()
    {
        ...
        Card p_Attack3 = new Attack_Card(2, 'a', 2, 3);
        cardsInDeck.add(p_Attack3);
        Card p_Attack4 = new Attack_Card(3,'a', 3, 2);
        ...
        Card p_Heal1 = new Heal_Card(6,'h', 2, 3);
        cardsInDeck.add(p_Heal1);
        Card p_Heal2 = new Heal_Card(7,'h', 3, 2);
        ...
        Card d_Attack3 = new Attack_Card(10, 'a', 2, 3);
        cardsInDeck.add(d_Attack3);
        Card d_Attack4 = new Attack_Card(11,'a', 3, 2);
        ...
        Card d_Heal1 = new Heal_Card(14,'h', 2, 3);
        cardsInDeck.add(d_Heal1);
        Card d_Heal2 = new Heal_Card(15,'h', 3, 2);
        ...
        Card s_Attack3 = new Attack_Card(18, 'a', 2, 3);
        cardsInDeck.add(s_Attack3);
        Card s_Attack4 = new Attack_Card(19,'a', 3, 2);
        ...
        Card s_Heal1 = new Heal_Card(22,'h', 2, 3);
        cardsInDeck.add(s_Heal1);
        Card s_Heal2 = new Heal_Card(23,'h', 3, 2);
        ...
        Card h_Attack3 = new Attack_Card(26, 'a', 2, 3);
        cardsInDeck.add(h_Attack3);
        Card h_Attack4 = new Attack_Card(27,'a', 3, 2);
        ...
        Card h_Heal1 = new Heal_Card(30,'h', 2, 3);
        cardsInDeck.add(h_Heal1);
        Card h_Heal2 = new Heal_Card(31,'h', 3, 2);
