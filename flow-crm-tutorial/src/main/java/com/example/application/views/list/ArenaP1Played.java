...
@PageTitle("ATLA")
@Route(value = "ArenaP1Played")

public class ArenaP1Played extends VerticalLayout implements GameObject {

    public ArenaP1Played() {

        System.out.println("card choice for player1 was: " + gameArena.p1CardChoice);
// ---------------- BACKGROUND HERE ---------------- //
...
// ---------------- NEXT TURN OF PLAYER 2 HERE ---------------- //
        ...
        nextTurn.addClickListener(e -> {
            ...
            {
                gameArena.p1.setMana(getP1Mana() + 1);
...
// ---------------- Making player 1 HERE ---------------- //
        ...
        Image card1 = new Image("images/card1.png", "card"); //replace with p1GetUnplayedCard1();
